            ...
            <div class="row">
                <div class="col-md-6 offset-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type='number' name='Percentage' id='Percentage' placeholder='Percentage' value='0' class="form-control form-inline" onKeyPress="if(this.value.length==2) return false;" onchange="calculatePercentage()">
                    </div>
                </div>
                ...
                <div class="col-md-12 meaningOfColorP">
                    ...
                    <p><span class="meaningOfColor btn" style="background-color:#a1dfd2;"></span>Total No. Of Bets</p>
                    <p><span class="meaningOfColor btn" style="background-color:#8c8d32;"></span>Total Players</p>
                    <p><span class="meaningOfColor btn" style="background-color:#7edb7a;"></span>Cutting Amount</p>
                </div>
                        ...
                        $(jodi).each(function(l) {
                            $(jodi[l]).each(function(j) {
                                ...
                                if(nR.data[n]){
                                    ...
                                    var tx = '<div class="sty"><div style="background-color:#2eb998;color:#fff;">'+nR.data[[n]]+'</div><div style="background-color: #3E5C78;">('+Math.round(clinetP)+')</div><div style="background-color: #EF974A;">('+Math.round(myP)+')</div><div style="background-color: #a1dfd2;">('+nR.dataCount[[n]]+')</div><div style="background-color: #8c8d32;">('+nR.dataDistinct[[n]]+')</div><div style="background-color: #7edb7a;">('+Math.round(cPer)+')</div></div>';
                ...
                success: function (res) {
                    ...
                    $(ak).each(function(l) {
                        if(nR.data[ak[l]]){
                            ...
                            var cPer = (myP * cuttingP/100);
                            var tx = '<div class="sty"><div style="background-color:#2eb998;color:#fff;">'+nR.data[l]+'</div><div style="background-color: #3E5C78;">('+Math.round(clinetP)+')</div><div style="background-color: #EF974A;">('+Math.round(myP)+')</div><div style="background-color: #a1dfd2;">('+nR.dataCount[l]+')</div><div style="background-color: #8c8d32;">('+nR.dataDistinct[l]+')</div><div style="background-color: #7edb7a;">('+Math.round(cPer)+')</div></div>';
                ...
                success: function (res) {
                    ...
                    $(sp).each(function(t) {
                        if(nR.data[sp[t]]){
                            ...
                            var cPer = (myP * cuttingP/100);
                            var tx = '<div class="sty"><div style="background-color:#2eb998;color:#fff;">'+nR.data[sp[t]]+'</div><div style="background-color: #3E5C78;">('+Math.round(clinetP)+')</div><div style="background-color: #EF974A;">('+Math.round(myP)+')</div><div style="background-color: #a1dfd2;">('+nR.dataCount[sp[t]]+')</div><div style="background-color: #8c8d32;">('+nR.dataDistinct[sp[t]]+')</div><div style="background-color: #7edb7a;">('+Math.round(cPer)+')</div></div>';
                ...
                success: function (res) {
                    ...
                    $(dp).each(function(p) {
                        if(nR.data[dp[p]]){
                            ...
                            var cPer = (myP * cuttingP/100);
                            var tx = '<div class="sty"><div style="background-color:#2eb998;color:#fff;">'+nR.data[dp[p]]+'</div><div style="background-color: #3E5C78;">('+Math.round(clinetP)+')</div><div style="background-color: #EF974A;">('+Math.round(myP)+')</div><div style="background-color: #a1dfd2;">('+nR.dataCount[dp[p]]+')</div><div style="background-color: #8c8d32;">('+nR.dataDistinct[dp[p]]+')</div><div style="background-color: #7edb7a;">('+Math.round(cPer)+')</div></div>';
                ...
                success: function (res) {
                    ...
                    $(tp).each(function(k) {
                        if(nR.data[tp[k]]){
                            ...
                            var cPer = (myP * cuttingP/100);
                            var tx ='<div class="sty"><div style="background-color:#2eb998;color:#fff;">'+nR.data[tp[k]]+'</div><div style="background-color: #3E5C78;">('+Math.round(clinetP)+')</div><div style="background-color: #EF974A;">('+Math.round(myP)+')</div><div style="background-color: #a1dfd2;">('+nR.dataCount[tp[k]]+')</div><div style="background-color: #8c8d32;">('+nR.dataDistinct[tp[k]]+')</div><div style="background-color: #7edb7a;">('+Math.round(cPer)+')</div></div>';
    ...
    function setOldData(){
        ...
        $(ak).each(function(l) {
            if(akData.data[ak[l]]){
                ...
                var cPer = (myP * cuttingP/100);
                rPer += cPer;
                var tx = '<div class="sty"><div style="background-color:#2eb998;color:#fff;">'+akData.data[ak[l]]+'</div><div style="background-color: #3E5C78;">('+Math.round(clinetP)+')</div><div style="background-color: #EF974A;">('+Math.round(myP)+')</div><div style="background-color: #a1dfd2;">('+akData.dataCount[l]+')</div><div style="background-color: #8c8d32;">('+akData.dataDistinct[l]+')</div><div style="background-color: #7edb7a;">('+Math.round(cPer)+')</div></div>';
                $('#'+l).html(tx);
            }else{
        ...
        $(sp).each(function(t) {
            if(spData.data[sp[t]]){
                ...
                var cPer = (myP * cuttingP/100);
                rPer += cPer;
                var tx = '<div class="sty"><div style="background-color:#2eb998;color:#fff;">'+spData.data[sp[t]]+'</div><div style="background-color: #3E5C78;">('+Math.round(clinetP)+')</div><div style="background-color: #EF974A;">('+Math.round(myP)+')</div><div style="background-color: #a1dfd2;">('+spData.dataCount[sp[t]]+')</div><div style="background-color: #8c8d32;">('+spData.dataDistinct[sp[t]]+')</div><div style="background-color: #7edb7a;">('+Math.round(cPer)+')</div></div>';
        ...
        $(dp).each(function(p) {
            if(dpData.data[dp[p]]){
                ...
                var cPer = (myP * cuttingP/100);
                rPer += cPer;
                var tx = '<div class="sty"><div style="background-color:#2eb998;color:#fff;">'+dpData.data[dp[p]]+'</div><div style="background-color: #3E5C78;">('+Math.round(clinetP)+')</div><div style="background-color: #EF974A;">('+Math.round(myP)+')</div><div style="background-color: #a1dfd2;">('+dpData.dataCount[dp[p]]+')</div><div style="background-color: #8c8d32;">('+dpData.dataDistinct[dp[p]]+')</div><div style="background-color: #7edb7a;">('+Math.round(cPer)+')</div></div>';
        ...
        $(tp).each(function(k) {
            if(tpData.data[tp[k]]){
                ...
                var cPer = (myP * cuttingP/100);
                rPer += cPer;
                var tx ='<div class="sty"><div style="background-color:#2eb998;color:#fff;">'+tpData.data[tp[k]]+'</div><div style="background-color: #3E5C78;">('+Math.round(clinetP)+')</div><div style="background-color: #EF974A;">('+Math.round(myP)+')</div><div style="background-color: #a1dfd2;">('+tpData.dataCount[tp[k]]+')</div><div style="background-color: #8c8d32;">('+tpData.dataDistinct[tp[k]]+')</div><div style="background-color: #7edb7a;">('+Math.round(cPer)+')</div></div>';
            ...
            $(jodi).each(function(l) {
                $(jodi[l]).each(function(j) {
                    ...
                    if(jodiData.data[n]){
                        ...
                        var cPer = (myP * cuttingP/100);
                        var tx = '<div class="sty"><div style="background-color:#2eb998;color:#fff;">'+jodiData.data[[n]]+'</div><div style="background-color: #3E5C78;">('+Math.round(clinetP)+')</div><div style="background-color: #EF974A;">('+Math.round(myP)+')</div><div style="background-color: #a1dfd2;">('+jodiData.dataCount[[n]]+')</div><div style="background-color: #8c8d32;">('+jodiData.dataDistinct[[n]]+')</div><div style="background-color: #7edb7a;">('+Math.round(cPer)+')</div></div>';
                        $('#'+jodi[l][j]).html(tx).css({'font-size':'19px'});
                    }
                });
            });
