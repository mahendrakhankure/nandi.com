    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="<?php echo base_url(); ?>" class="logo">
          ...
          <span class="logo-lg"><b>NANDI</b></span>
        </a>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu" data-widget="tree">
            <li class="header">MAIN NAVIGATION   <b><?=date('d-m-Y')?></b></li>
            <li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li>
                  ...
                  <!-- <a href="<?php echo base_url(); ?>Manage_Matkaallgames"><i class="fa fa-circle-o"></i>All Result</a> -->
                </li>
                <li>
            ...
            <li class="treeview">
              <a href="javascript:void(0)">
                <i class="fa fa-sun-o" aria-hidden="true"></i> <span>Worli Matka Day Game</span>
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
              <ul class="treeview-menu">
                <li>
                  <a href="<?php echo base_url(); ?>0014fbc9f53bc70c4ae5f9d47aa2b5c9">
                    <i class="fa fa-circle-o"></i>
                    Worli Matka Day All Bets
                  </a>
                </li>
                <li>
                  <a href="<?php echo base_url(); ?>08f76ac8582bfa4e9e9e18a23a75e8e1">
                    <i class="fa fa-circle-o"></i>
                    Worli Matka Day Bhav
                  </a>
                </li>
                <li>
                  <a href="<?php echo base_url();?>34642c7cc851bdfd6834b7940e59026e">
                    <i class="fa fa-circle-o"></i>
                    Worli Matka Day Result
                  </a>
                </li>
                <li>
                  <a href="<?php echo base_url();?>242e20696e8ccf521304bafa25deba4e">
                    <i class="fa fa-circle-o"></i>
                    Worli Matka Day Winner List
                  </a>
                </li>
              </ul>
            </li>
            ...
            <!-- <li class="treeview">
              <a href="javascript:void(0)">
                <i class="fa fa-moon-o" aria-hidden="true"></i> <span>Worli Matka Night Game</span>
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
              <ul class="treeview-menu">
                <li>
                  <a href="<?php echo base_url(); ?>a5f7fb478501800fd4809dba0457b3f8">
                    <i class="fa fa-circle-o"></i>
                    Worli Matka Night All Bets
                  </a>
                </li>
                <li>
                  <a href="<?php echo base_url(); ?>fde1bddc62c5b0a9494afcfff7676e97">
                    <i class="fa fa-circle-o"></i>
                    Worli Matka Night Bhav
                  </a>
                </li>
                <li>
                  <a href="<?php echo base_url();?>5816f6eadaea1ccb550214321748aa7d">
                    <i class="fa fa-circle-o"></i>
                    Worli Matka Night Result
                  </a>
                </li>
              </ul>
            </li> -->
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li>
                  <a href="<?php echo base_url(); ?>f475344d3c18a6b3a211b4fed6f12458"><i class="fa fa-circle-o"></i>Customer List</a>
                </li>
                <li>
                  <a href="<?php echo base_url(); ?>85b1d2982c1e9a4d4a489247d6e92834"><i class="fa fa-circle-o"></i>Worli Matka Day Live Settlement</a>
                </li>
                <li>
                  <a href="<?=base_url()?>4afb875daabfd071a2818c10852a3928"><i class="fa fa-circle-o"></i>Regular Live Settlement</a>
                  <!-- <a href="<?=base_url()?>a63973b181b0c52cf1e74629fc6d50ff"><i class="fa fa-circle-o"></i>Regular Live Settlement</a> -->
                  <!-- <a href="<?=base_url()?>d6afe43edc4aa569bd3252c63674c690"><i class="fa fa-circle-o"></i>Regular Live Settlement</a> -->
                </li>
                <!-- <li>
                  <a href="<?=base_url()?>635ca881874e8997fbb4bd0ee706a6b0"><i class="fa fa-circle-o"></i>Worli Matka Night Live Settlement</a>
                </li> -->
                <!-- <li>
                  <a href="<?=base_url()?>29c84e979cf8e713d94bf77a3cdba080"><i class="fa fa-circle-o"></i>Video List</a>
                </li> -->
                <li>
                  <a href="<?=base_url()?>0571b3cbce86ae08dc5ba2b744302e53"><i class="fa fa-circle-o"></i>Video List</a>
                </li>
                <li>
                  <a href="<?=base_url()?>673d1219093f544ecc33e3d3c85f069c"><i class="fa fa-circle-o"></i>Out Market Cutting</a>
                </li>
                <li>
                  <a href="<?php echo base_url(); ?>d383679f6c7f94714026d747f9f77f33"><i class="fa fa-circle-o"></i>Bazar Back Business</a>
                </li>
                <li>
                  <a href="<?php echo base_url(); ?>70fed1623f9897a31ac8a6e50023cc58"><i class="fa fa-circle-o"></i>Resettlement</a>
                </li>
                <li>
                  <a href="<?php echo base_url(); ?>e2392d2c34003606d9478ac36e766e40"><i class="fa fa-circle-o"></i>Holidays</a>
                </li>
                <li>
                  <a href="<?php echo base_url(); ?>2b8c2d994a9278e1ba9e5550010d77f2"><i class="fa fa-circle-o"></i>All Clients</a>
                </li>
                <li>
                  <a href="<?php echo base_url(); ?>0dd506e396bf18ea8798d354bb9acd6f"><i class="fa fa-circle-o"></i>Last Change</a>
                </li>
                <li>
                  <a href="<?=base_url()?>ea8121ad3617938478e90e8a81a1b058"><i class="fa fa-circle-o"></i>Check Market Cutting</a>
                </li>
                <!-- <li>
                  <a href="<?=base_url()?>f80d15e4e53ed623b385a4b62b1cef38"><i class="fa fa-circle-o"></i>Cutting History</a>
                </li> -->
                <li>
                  <a href="<?php echo base_url(); ?>6060624ec45717af91f2e27378e83ed2"><i class="fa fa-circle-o"></i>Worli Result</a>
                </li>
                <li>
                  <a href="<?php echo base_url(); ?>d16bfd08904d758109198f765ea2c4fe"><i class="fa fa-circle-o"></i>Send Cutting Data On Whats App</a>
                </li>
              </ul>
            </li>
            <!--end code for Global -->
            ...
            <li><a href="<?=base_url()?>5e1e2ea84d99f30fb324ceb6c034583e"><i class="fa fa-bolt" aria-hidden="true"></i>Instant Worli settlement</a></li>
            <li><a href="<?=base_url()?>f4993364a3d838b4174d4a40bd82604f"><i class="fa fa-eye"></i>Matka Streaming Result</a></li>
            <!-- <li><a href="<?=base_url()?>762a1c6be55b9a89fceffe61a6666aa2">Customer Rate</a></li> -->
            <li><a href="<?=base_url()?>e2392d2c34003606d9478ac36e766e34"><i class="fa fa-money" aria-hidden="true"></i>Customer Rate List</a></li>
