    ...
    <script src="<?php echo base_url(); ?>assets/js/my_functions.js" type="text/javascript"></script>
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/admin/js/pagination.js" charset="utf-8"></script>
