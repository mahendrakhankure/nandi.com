...
?>
	...
	<div class="content-wrapper">
		<section class="content-header">
	      <div>
			<h1>
				<i class="fa fa-users"></i> Manage King Bazar Games
				<small></small>
			</h1>
		  </div>
	    </section>
				...
				<div class="form-group">
				    <div class="col-xs-12">
				        <div class="form-inline">
				            ...
				            <!-- <div class="form-group">
				                <input type="date" class="form-control" id="result_date" placeholder="Search Result Date ID"/>
				            </div> -->
							<div class="form-group">
...
<script type="text/javascript">
	$(document).ready(function(){
	   	var userDataTable = $('#userTable').DataTable({
	      	...
	      	'columns': [
	         	{ data: 'result_date','render':function(data, type, row, meta){
                    return row.sr;
                }},
	         	{ data: 'transaction_id' },
	         	//{ data: 'partner_id' },
	   	...
	   	$('#transaction_id,#partner_id,#customer_id,#bazar_name,#game_name,#result_date').change(function(){
	   		userDataTable.draw();
	   	});
		function sleep(ms) {
