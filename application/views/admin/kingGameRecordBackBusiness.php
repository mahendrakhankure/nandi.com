...
<p class="hidden" id="from"><?=$_GET['from']?></p>
<p class="hidden" id="to"><?=$_GET['to']?></p>
<div class="content-wrapper">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h3 class="title"><?=strtoupper(urldecode($bazarName))?> (<?=urldecode($gameName)?>)</h3>
            </div>
        </div>
        <div class="row">
        ...
        var userDataTable = $('#userTable').DataTable({
            ...
            'ajax': {
              ...
              'data': function(data){
                    ...
                    data.result_date = $('#from').text();
                    data.to_date = $('#to').text();
              }
            },
            'columns': [
