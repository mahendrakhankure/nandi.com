...
?>
    ...
    <div class="content-wrapper">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                            ...
                            <p class="time">
                                ...
                                ?>
                                <a href="<?=base_url();?>b71c70d91e49a65ede30de4102aea45a/<?=$bazar_id?>/<?=$list['game_id']?>/3/<?=$list['game_name']?>?from=<?=$from?>&&to=<?=$to?>">
                                    <span class="t otime">
                                        Jodi
                                    </span>
                                </a>
                                ...
                                ?>
                                    <a href="<?=base_url();?>b71c70d91e49a65ede30de4102aea45a/<?=$bazar_id?>/<?=$list['game_id']?>/1/<?=$list['game_name']?>?from=<?=$from?>&&to=<?=$to?>">
                                        <span class="t otime">
                                            Open
                                        </span>
                                    </a> 
                                    <span class="time-divider">|</span> 
                                    <a href="<?=base_url();?>b71c70d91e49a65ede30de4102aea45a/<?=$bazar_id?>/<?=$list['game_id']?>/2/<?=$list['game_name']?>?from=<?=$from?>&&to=<?=$to?>">
                                        <span class="t ctime">
                                            Close
                                        </span>
                                    </a>
                            ...
                            <div class="inner">
                                    ...
                                    <p> <span class="ctext"> GGR </span> : <span class="cvalue bets"><?=round(($list['point']-$list['win']),2);?></span></p>
        ...
        <div class="tabs">
            ...
            <label for="tab2" onclick="getTabDataBackBusiness('<?=$_GET['from']?>','<?=$_GET['to']?>',<?=$bazar_id?>,'JODI',<?=$rs?>)">
                <!-- <i class="fa fa-css3"></i> -->
                <span>JODI</span>
            </label>

            <input type="radio" name="tabs" id="tab3">
            <label for="tab3" onclick="getTabDataBackBusiness('<?=$_GET['from']?>','<?=$_GET['to']?>',<?=$bazar_id?>,'SINGLEPATTI',<?=$rs?>)">
                <!-- <i class="fa fa-code"></i> -->
                <span>SINGLE PATTI</span>
            </label>

            <input type="radio" name="tabs" id="tab4">
            <label for="tab4" onclick="getTabDataBackBusiness('<?=$_GET['from']?>','<?=$_GET['to']?>',<?=$bazar_id?>,'DOUBLEPATTI',<?=$rs?>)">
                <!-- <i class="fa fa-code"></i> -->
                <span>DOUBLE PATTI</span>
            </label>

            <input type="radio" name="tabs" id="tab5">
            <label for="tab5" onclick="getTabDataBackBusiness('<?=$_GET['from']?>','<?=$_GET['to']?>',<?=$bazar_id?>,'TRIPLEPATTI',<?=$rs?>)">
                <!-- <i class="fa fa-code"></i> -->
            ...
            <div id="tab-content1" class="tab-content">
                <div style="float: right;">
                    <p style="font-size: 15px;font-weight: 600;">Total Bet => <span id="tasd"></span></p>
                    <p style="font-size: 15px;font-weight: 600;">Total Win => <span id="tasd3"></span></p>
                    -------------------------------
                    <p style="font-size: 15px;font-weight: 600;">      GGR => <span id="tasd4"></span></p>
                </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <?php 
                                $tOpen = 0;
                                $tOpenWin = 0;
                                $con=' WHERE result_date BETWEEN "'.$_GET['from'].'" AND "'.$_GET['to'].'" AND bazar_name="'.$bazar_id.'" AND game_name="5" AND game_type="Open"';
                                // $feilds = 'SUM(point) as amt,game';
                                $feilds = 'SUM(point_in_rs) as amt,(SUM(winning_in_rs)+SUM(commission_in_rs)) as win,game';
                        ...
                        <tr>
                            ...
                            <?php 
                                $tClose = 0;
                                $tCloseWin = 0;
                                $con1=' WHERE result_date BETWEEN "'.$_GET['from'].'" AND "'.$_GET['to'].'"  AND bazar_name="'.$bazar_id.'" AND game_name="5" AND game_type="Close"';
                                $feilds1 = 'SUM(point) as amt,(SUM(winning_in_rs)+SUM(commission_in_rs)) as win,game';
                        ...
                        <span style="display:none;" id="tasd2"><?=$tOpenWin+$tCloseWin?></span>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#tasd').text($('#tasd1').text());
        $('#tasd3').text($('#tasd2').text());
        $('#tasd4').text((parseInt($('#tasd1').text())-parseInt($('#tasd2').text())));
    });
</script>