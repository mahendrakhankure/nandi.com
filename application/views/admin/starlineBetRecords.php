        ...
        <div class="row">
            ...
            ?>
                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                    <div class="starMain">
                        <a href="<?=base_url().'b4ffb330bdc320c0a7e29e6d251fbccb/'.$data['bazar_id'].'/'.$data['bazarName']?>">
                            <div class="inner">
                                <h4><?=$data['bazarName']?></h4>
                                <!-- <p><?=$data['id']?></p>
                                <p><?=empty($data['point'])?0:$data['point'];?></p> -->
                                ...
                                <p> <span class="ctext"> Players </span> : <span class="cvalue bets"><?=empty($data['player'])?0:$data['player'];?></span></p>
                            </div>
                        </a>
                    </div>
                </div>
