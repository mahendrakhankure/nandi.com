...
?>
	...
	<div class="content-wrapper">
	    ...
	    <section class="content-header">
	      <div>
			<h1>
				<i class="fa fa-users"></i> Manage King Bazar Result
				<small></small>
			</h1>
		  </div>
...
<script type="text/javascript">
	$(document).ready(function(){
	   	var userDataTable = $('#userTable').DataTable({
	      	...
	      	'ajax': {
	          'url':'<?=base_url()?>36481284d96d48642e9e9a683c46a0fe',
	          'data': function(data){
	      	...
	      	'columns': [
	         	...
	         	{ data: 'action' ,'render':function(data, type, row, meta){
	         		return '<a class="btn btn-sm btn-info" href="<?php echo base_url(); ?>Manage_Kingbazarallresult/AddKingBazarResult/'+row.result_id+'" title="Edit"><i class="fa fa-pencil"></i></a>';
	         		
	         	}},
	         	{ data: 'rollback' ,'render':function(data, type, row, meta){
	         		return '<a class="btn btn-sm btn-danger" href="<?php echo base_url(); ?>c1668013ed412d2d15dccf04fc362c96/'+row.result_id+'" title="Edit"><i class="fa fa-times"></i></a>';
	...
	function voidBet(id){
		if(confirm('Do You Want To Void This?')){
	   		$.ajax({
	            ...
	            data: {table:'king_bazar_game',bazar_id:id,market:'king_bazar_game'},
