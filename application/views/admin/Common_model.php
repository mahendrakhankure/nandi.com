	...
	Class Common_model extends CI_Model {
		...
		function getRegularData($postData=null){
	  	...
	  	function getWorliData($postData=null){
		      ...
		      $feilds = 'created,game_name,point,commission,winning_point,status,game,result_date,transaction_id,partner_id,customer_id,round_id';
