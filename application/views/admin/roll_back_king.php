...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <h1>
        ...
        <i class="fa fa-users"></i> King Bazar Result Roll Back
            ...
            <div class="col-md-8">
              ...
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" id="addUser" action="<?php echo base_url(); ?>c1668013ed412d2d15dccf04fc362c96/<?php echo $result['id']; ?>" method="post" role="form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" id="result_patti" value="<?php echo $onegamedata['result_patti']; ?>" name="result_patti" maxlength='2' minlength="2" onkeypress="return isNumber(event)" required>
