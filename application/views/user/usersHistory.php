        ...
        <div class="container">
            <div class="row">
                ...
                <label for="tab1">
                    ...
                    <img src="<?=base_url();?>assets/images/icon1.png">
                    <span>Regular Bazar</span>
                </label>

                <input type="radio" name="tabs" id="tab2">
                <label for="tab2" onclick="getUserData('starline_bazar_game','<?php echo $pID; ?>','<?php echo $cID; ?>')">
                    <!-- <i class="fa fa-css3"></i> -->
                    <img src="<?=base_url();?>assets/images/icon3.png">
                    <span>Starline Bazar</span>
                </label>

                <input type="radio" name="tabs" id="tab3">
                <label for="tab3" onclick="getUserData('king_bazar_game','<?php echo $pID; ?>','<?php echo $cID; ?>')">
                    <!-- <i class="fa fa-code"></i> -->
                    <img src="<?=base_url();?>assets/images/icon2.png">
                ...
                <div id="tab-content2" class="tab-content">
                    <div id="starline_bazar_game"></div>
                </div>

                <div id="tab-content3" class="tab-content">
                    <div id="king_bazar_game"></div>
                </div>
            </div>
            </div>
        </div>
