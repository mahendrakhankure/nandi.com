...
?>
        ...
        <div class="controlDv akdDV">
            <div class="bett-var-form  ">
                ...
                <div class="var-type-sf controlDv">   
                    <input type="number" name="s1" id="_s1" placeholder="Open Patti" required minlength="3" maxlength="3" onkeypress="return isNumber(event)" oninput="maxLengthCheck(this)">
                    <input type="number" name="s2" id="_s2" placeholder="Close Patti" required minlength="3" maxlength="3" onkeypress="return isNumber(event)" oninput="maxLengthCheck(this)">
        ...
        <input type="radio" id="sangam" name="gt-radio" value="Full Sangam" disabled="" checked="" style="visibility:hidden">
