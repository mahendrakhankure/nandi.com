    ...
    <style type="text/css">
        ...
        <div class="container gv-wrapper" >
            <div class="row">
                ...
                <hr>
                <center class="clockdiv" data-date="<?=date('Y-m-d H:i:s',strtotime($gameDetail['time']))?>">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="gamelist">
                        ...
                        ?>
                            <a href="<?=base_url();?>d04cd65a193d25064eb7375b799adc29/<?=$gameDetail['bazar_id']?>/<?=$games['id']?>/<?=$gameDetail['id']?><?=$tUrl?>">
                                <div class="game">
