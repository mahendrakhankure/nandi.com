...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $(data).each(function(i) {
            dome='<div class="chipbox-inner-wrapper" onclick="addCoinSingleDigit('+data[i]+',/SingleDigit/)"><span>'+data[i]+'</span><div class="chipbox"><span id="Single'+data[i]+'Akda" class="centered"></span></div></div>';
            $('#dome').append(dome);
        });
    });
</script>