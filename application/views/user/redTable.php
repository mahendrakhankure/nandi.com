...
?>
    ...
    <div class="container container-custom">
        ...
        <div class="col-md-12 promo-video" id="streming">
            <img src="<?=base_url()?>assets/images/live.gif" height='20px' style="left: 7px;position: relative;top: 25px;">
            <?php
                if($buf['status']=='1'){
            ?>
                <!-- <span><i class="fa-solid fa-message"></i></span> -->
                <iframe src="https://matkaui.livedealersol.com/Video/Video?token=QVbu0naS1M&table=Matka-4" title="Live Satta Result" id="iFrameWin" style="width: 100%;"></iframe>
        ...
        <div class="betResSection">
            ...
            <div class="clrBoth"></div>
            <a href="javascript:void(0)"  onclick="placeBetRedTable()" class="plceBet">Place Bet</a>
        </div> 
    </div>
    <?php
    	...
    	$(document).ready(function(){
            ...
            for (let l = 0; l < arr.length; l += chunkSize) {
                ...
                $(chunk).each(function(t) {
                    dome += '<td><div class="cplace place-input-main" onclick="addCoinRedTable('+chunk[t]+',/'+"SingleDigit"+'/)"><label class="inputNo">'+chunk[t]+'</label><div class="cplace-box btInput pos"><div id="SinglePatti'+chunk[t]+'Akda-wrapper" class="text-center"></div></div></div></td>';
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            if(parseInt(viewWidth) > 340 && parseInt(viewWidth) <= 460) {
                cplaceHeight = viewHeight-350+60;
                $(".cplace-outer").height(cplaceHeight);
