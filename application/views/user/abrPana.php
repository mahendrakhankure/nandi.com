        ...
        <div class="rows">
            ...
            <div class="col-md-6 col-sm-8  offset-md-3 offset-sm-2 game-type">
                <div class="game-open-close" id="game-open-close">   
                    <form> 
                           <div class="gt-open">
                            <input type="radio" id="open123" name="gt-radio" value="open" <?= $status[0]['game_type1'] == 'NULL' ? 'disabled  onclick="error(Open Result Is Already Decleared!)"':''; ?>>
            ...
            <div class="col-md-8 offset-md-2 p5-bet-form">
                ...
                <input type="number" name="ent-amount" id="ent-amount" placeholder="Enter Amount" required maxlength="4" onkeypress="return isNumber(event)">
                <button onclick="addBets('<?=$gameDetail['game_name']?>')">+ Add Pana</button>
    ...
    <div class="container">
        <div class="rows">          
            <div class="col-12 chipbox-action" id="pBet">
                <a onclick="PlaceBets()" style="cursor: pointer;">PLACE BET</a>
