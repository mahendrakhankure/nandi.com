...
<body>
    ...
    <div id="mySidenav" class="sidenav text-center" style="top:50px;">
        <ul>
            ...
            <li><a href="<?=base_url()?>d22e6d9a374680c5deecbc33f514e662/goldenTable_result">Last Result</a></li>
        </ul>
    </div>
...
<div class="modal" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true"  onclick="$('#exampleModalCenter').hide();">
  <div class="modal-dialog modal-dialog-centered" role="document">
    ...
    <div class="col-md-12 promo-video" id="streming">
        ...
        <iframe src="https://matkaui.livedealersol.com/Video/Video?token=QVbu0naS1M&table=Matka-5" title="Live Satta Result" id="iFrameWin"></iframe>
        <!-- <iframe src="https://matkaui.livedealersol.com/Video/Video?token=QVbu0naS1M&table=Matka-2" title="Live Satta Result" id="iFrameWin"></iframe> -->
        ...
        <div class="container">
            <div class="rows">
                <div class="col-md-8 col-sm-10 offset-md-2 offset-sm-1 bett-action" id="pBet">
                    ...
                    <a href="javascript:void(0)" onclick="placeBetGoldenTable()">PLACE BET</a>
                </div>
            </div>
        </div>
    ...
    <script>
    	$(document).ready(function(){
            ...
            var dome = '';
            $(arr).each(function(t) {
                dome += '<div class="cplace" onclick="addCoinGoldenTable('+arr[t]+',/'+"SingleDigit"+'/)"><span>'+arr[t]+'</span><div class="cplace-box"><div id="SinglePatti'+arr[t]+'Akda-wrapper" class="text-center"></div></div></div>';
            });
