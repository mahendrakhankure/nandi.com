   ...
   <!-- <script src="<?php echo base_url(); ?>assets/dist/js/bootstrap/bootstrap.min.js.map"></script> -->
    ...
    <script type="text/javascript">
        ...
        //     if(url!=''){
        //         if("<?=basename(current_url())?>"!="4ad7b357b4a728f18d6e27dea29a071e"){
        //             $.ajax({
        //               type: "POST",
        ...
        //                 // console.log(res)
        //                 var ak = JSON.parse(res);
        //                 if(ak.code=='200'){
        //                     if(ak.balance!=$('#CustomerAmount').text()){
        //                         $('#CustomerAmount').empty();
        //                         $('#CustomerAmount').append(ak.balance);
        //                         $('#myBalance').val(ak.balance);
        //                     }
        //                 }
        //               }
        //             });
